...
let expr_alt_1 : choice = { name = "alt1"; patterns = [t; plus; e] }
let expr_alt_2 : choice = { name = "alt2"; patterns = [t] }

let expr = { name = "expr"; choices = [expr_alt_1; expr_alt_2]; pos = (1, 0, 0, 0) }

let a : pattern = { ty = Reference ("atom", NoMod); ref = Some "a" }
let mul : pattern = { ty = Quote "*"; ref = None }

let term_alt_1 : choice = { name = "alt1"; patterns = [a; mul; t] }
let term_alt_2 : choice = { name = "alt2"; patterns = [a] }

let term = { name = "term"; choices = [term_alt_1; term_alt_2]; pos = (0, 0, 0, 0) }

let num_pattern : pattern = { ty = Regex "[1-9][0-9]*"; ref = None }
let num_choice : choice = { name = "alt1"; patterns = [num_pattern] }
...
let atom_alt_1 : choice = { name = "alt1"; patterns = [n] }
let atom_alt_2 : choice = { name = "alt"; patterns = [l_paren; e; r_paren ] }
